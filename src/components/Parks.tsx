    ...
    <div className="parks">
      ...
      <div className="second-park">
        <Container>
          <Row>
            <Col md={8}>
              <h3> ادارة الحدائق العامه</h3>

              <p>
                نظام تطوير وإدارة الحدائق العامة بمنظومة خدمة الترفيه وفق الطلب
                برنامج استشاري يحقق أهداف الجهات الحكومية مالكة الحدائق العامة
                وكبرى المؤسسات التي تتبنى مبادرات خدمة المجتمع ،، يحقق السعادة،
                وجودة الحياة والتنمية المستدامة وفقاً لتطبيق ثلاثة ركائز..
                <span>عرض المزيد</span>
              </p>
            </Col>
            <Col md={4}>
